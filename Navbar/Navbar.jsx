...
function Navbar() {
  ...
  return (
    <div className="relative ">
      <div className="flex fixed justify-around overflow-hidden items-center text-white h-[100px] z-50  bg-[url('https://assets-global.website-files.com/6571cd8955f9e7f772615980/659ff7ba19b066a186929466_timer-bg.webp')] bg-no-repeat border-4 border-solid  border-[#682466] w-screen ">
        <div className="absolute left-0  inset-y-0 flex items-center ">
          ...
          <a
            ...
            target="_blank"
            className="bg-[#7957ff] bg-[url('https://assets-global.website-files.com/6571cd8955f9e7f772615980/65b10941b16f3335ac99630e_bybit-bg-btn.svg')] bg-no-repeat rounded-lg hover:bg-blue-600 text-white font-dm-mono font-semibold text-[18px] py-2 pr-24 px-6 w-64 shadow-[0_11px_29px_rgba(121,87,255,.8)] ml-28"
            style={{
        ...
        <div className="absolute right-0  flex items-center ">
          <a
            href="https://www.bybit.com/en/trade/spot/GTAI/USDT?affiliate_id=71085&amp;ref_code=GTPROTOCOL"
            target="_blank"
            className="bg-[#7957ff] bg-[url('https://assets-global.website-files.com/6571cd8955f9e7f772615980/65b10941b16f3335ac99630e_bybit-bg-btn.svg')] bg-no-repeat rounded-lg hover:bg-blue-600 text-white font-dm-mono font-semibold text-[18px]  w-64 py-2 pr-24 px-6 z-10 shadow-[0_11px_29px_rgba(121,87,255,.8)] mr-28"
            style={{
              backgroundSize: "auto 20px",
              backgroundPosition: "160px 9px",
            }}
...
<div className=" w-screen h-[100px]"></div>
      ...
      <nav
        role="navigation"
        className={`flex z-40 absolute flex-row justify-between rounded-lg border-solid border-gray-900 border-2 bg-opacity-33 bg-[#0d0f1b54] text-[#f3f4fb] mt-4 left-5 right-5  h-16 items-center   transition-transform duration-300 ease-in-out transform ${
      ...
      >
        ...
        <div className="nav-action flex flex-wrap flex-row  space-x-4">
          <a
            ...
            target="_blank"
            className="relative btn-primary-frame bg-[#542fe8] flex flex-wrap items-center text-white rounded-lg px-2 py-2 w-32 h-11  border-[#542fe8] border-2"
          >
            <img
        ...
        <div className="nav-action  flex-wrap flex-row  space-x-4 hidden    lg:flex">
          <a
            ...
            href="https://staking.gt-protocol.io?"
            target="_blank"
            className="relative btn-primary-frame bg-[#542fe8] flex flex-wrap items-center text-white rounded-lg px-2 py-2 w-32 h-11  border-[#542fe8] border-2 bg-[#0d0f1b54]"
          >
      ...
      {isMenuOpen && (
        <nav
          role="navigation "
          className={`flex flex-col justify-items-start space-y-4 space-x-2  rounded-lg border-solid border-gray-900 border-2 bg-opacity-33 bg-[#18191bf2] text-[#f3f4fb]  mt-1 ml-9 mr-9   max-w-full transition-transform duration-300 ease-in-out transform lg:hidden ${
            isHidden ? "-translate-y-full" : "translate-y-0"
          } ${isTransitioning ? "opacity-0" : "opacity-100"}`}
